...
/**
 * Configuración de OpenAPI/Swagger para el microservicio de Estados
 * 
...
public class OpenAPIConfig {
    ...
    public OpenAPI apiInfo() {
        ...
        server.setDescription("Servidor de desarrollo - Microservicio de Estados");
        ...
        Info info = new Info()
                .title("QualifyGym - Microservicio de Estados")
                .version("1.0.0")
                .description("API REST para la gestión de estados del sistema QualifyGym. " +
                        "Los estados representan el estado de activación de diferentes entidades " +
                        "del sistema (Activo, Inactivo, Pendiente, Eliminado). " +
                        "Incluye operaciones CRUD y búsqueda por nombre.")
                .contact(contact)
                .license(license);
