...
public interface NotificacionRepository extends JpaRepository<Notificacion, Long> {
    ...
    // Buscar notificaciones por comentario
    @Query("SELECT n FROM Notificacion n WHERE n.comentarioId = :comentarioId ORDER BY n.fechaCreacion DESC")
    List<Notificacion> findByComentarioId(@Param("comentarioId") Long comentarioId);
}
